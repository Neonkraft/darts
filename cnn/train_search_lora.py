...
parser.add_argument('--save', type=str, default='runs', help='experiment name')
parser.add_argument('--seed', type=int, default=2, help='random seed')
parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')
parser.add_argument('--train_portion', type=float, default=0.5, help='portion of training data')
parser.add_argument('--lora_r', type=int, default=4, help='Rank of LoRA approximation')
...
def main():
  ...
  checkpoint = torch.load(args.trained_supernet_path)
  checkpoint = {k: v for k, v in checkpoint.items() if 'lora' not in k}
  model.load_state_dict(checkpoint, strict=False)
  model.freeze_non_lora_modules()
